...
This is the cloned repository of the submitted short-paper: "A Transfer Learning-based Training Approach for DGA Classification". [Original repository](https://gitlab.com/rwth-itsec/dga-transfer-learning-based-training)
